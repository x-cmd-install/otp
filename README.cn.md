...
合计: **2,745,128** 行代码（覆盖前 5 种语言、共 **5337** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Erlang | 1,781,512 | 304,545 | 292,182 | 4080 |
| C | 395,162 | 59,313 | 68,830 | 601 |
| Cpp | 156,233 | 12,824 | 22,948 | 119 |
| CHeader | 115,494 | 43,506 | 21,608 | 465 |
...
- **Star**: 12,341 · **Fork**: 3,276 · **开放 issue**: 3,556 · **贡献者**: 871

## 累计统计

- **发布数**: 383 · **已合并 PR**: 6111 · **开放 PR**: 219 · **已关闭 issue**: 3168 · **开放 issue**: 388 · **提交数**: 66565
...
_数据快照: `data/card/260926.yml` · 2026-09-26T04:47:50Z._
